...
* **(R7h)** CountLove embodies collect, imagine, and teach in a clear way. CountLove collects a large amount of data that is difficult to collect correctly, and this data is used in very important ways in which it can share power and help people understand the impact of social issues and protests. CountLove also embodies imagine as their mission is to help the people of America to use protest data to create compelling cases for a diverse, empathetic, and kind country. CountLove embodies teach in a powerful way just by making their data accesible for use. The ease in which data can be converted into csv files and used for analysis is a great tool for the next generation of data analyzers and is something that can be used for teaching, but also educating those who are learning.
* **(R7i)** The most interesting thing I learned from this analysis was to see the frequency in which different protest purposes occurred. I think the frequency is a good refelction of the purposes that America cares about the most and is willing to take action for the most, such as racial and civil topics.
* **(R7j)** Analysis that I would like to do that would be interesting using CountLove data would be to analyze the locations and which areas of each states are likely or more active when it comes to protests. For example, seeing certain areas in Washington that have higher amounts of protests, and from that we can learn about the area or demographic of protests, especially since some of the locations from the dataset are located on college campuses.
